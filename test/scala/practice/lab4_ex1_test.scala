...
//          ALU_SLL , ALU_SLTU , ALU_SRL , ALU_SRA , ALU_COPY_A , ALU_COPY_B ,ALU_COPY_C,ALU_COPY_D,ALU_XXX )
//     for ( i <- 0 until 100) {
...
//             case ALU_SLL => src_a << ( src_b )
//             case ALU_SLTU => ( src_a < src_b ) . asInstanceOf [ Int ]
//             case ALU_SRL => src_a >> ( src_b )
//             case ALU_SRA => src_a . toInt >> ( src_b )
//             case ALU_COPY_A => src_a
//             case ALU_COPY_B => src_b
//             case ALU_COPY_C => src_a === src_b
//             case ALU_COPY_D => src_a =/= src_b
//             case _ => 0
//         } 
